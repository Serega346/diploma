    ...
    <div className='cart'>
      <div className='dropdown'>
        <Link
          to='/basket'
        >
          <svg id="Capa_1" enableBackground="new 0 0 32 32" height="32" viewBox="0 0 512 512" width="32" xmlns="http://www.w3.org/2000/svg">
            <g>
            ...
            <text id="text" x="170" y="420" fontSize="300">
              {totalBasketCount}
            </text>

          </svg>
          {/*<span> item(s) - ${totalPrice}</span>*/}
        </Link>
      </div>
    </div>
  )
